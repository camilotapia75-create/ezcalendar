export default function FlyerModal({ flyer, onDelete, onClose }) {
  const displayDate = new Date(flyer.date + 'T12:00:00').toLocaleDateString('en-US', {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="p-5">
          {flyer.title && (
            <h3 className="font-bold text-lg leading-tight mb-2">{flyer.title}</h3>
          )}
